...
public class AdtMessageFactory {
	public static Message createMessage(String messageType, String hL7Message) throws HL7Exception, IOException {
        
        //This patterns enables you to build other message types 
        if ( messageType.equals("A01") )
        {
            return new OurAdtA01MessageBuilder().Build(hL7Message);
        }
